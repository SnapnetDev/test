                    ...
                    <td>{{$user->name}}</td>
                     <td>{{$user->job?$user->job->department->name:''}}</td>
                      <td>{{$user->job?$user->job->title:''}}</td>
                       ...
                       <td><a class="btn btn-info" href="{{ url('bsc/set_employee_kpi').'?employee='.$user->id.'&mp='.$mp->id }}">Set Up Evaluation</a>
                           @if($mp->status==1)
                           <a class="btn btn-info" href="{{ url('bsc/get_evaluation').'?employee='.$user->id.'&mp='.$mp->id }}">Evaluate</a>
                      @endif
                       </td>
                  </tr>
                  @endforeach
