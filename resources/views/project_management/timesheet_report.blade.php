        ...
        <div class="page">
            ...
            <div class="page-main">
                ...
                <div class="page-header">
                    <h1 class="page-title">Timesheet Report for {{date('M-Y',strtotime($date))}}</h1>
                ...
                <div class="page-content container-fluid">
                    ...
                    <form id="monthForm" method="GET" action="{{url('projects/get_month_report')}}" >
                    ...
                    <table id="data_table" class="table">
                        ...
                        @foreach($report as $report_info)
                            <tr>
                                ...
                                <td>@foreach($report_info['projects'] as $project)
                                    @if($project['sum']>0) 
                                    {{$project['name']}}({{$project['fund_code']}})-{{$project['sum']}} hours({{$project['sum']>0 ?round(($project['sum']/$report_info['total_hours'])*100,2):0}}%)<br>
                                    @endif
                                    @endforeach</td>
                                    <td>{{$report_info['leave_hours']}}</td>
                                    <td>{{$report_info['holiday_hours']}}</td>
